...
const api = {
  key: "37dfaff60aea1582d45b89dd6ad48e15",
...
function App() {
  ...
  //Creating Date function let run dynamicly
  const dateBuilder = (d) => {
  ...
  return (
    //create an dynamic backgorund change by checking the weather by creating by adding class changes
    //by using typeof we can return the string and use it as defined or undefined
    <div className=
...
//The way to defind the location and weather dinamycly we need to gather the information from the console log and display the result on the page
//
export default App;
